...
def classify_image(image_path: str, thresholds: dict, region_low_percentile: float) -> dict:
...
def main() -> None:
    ...
    for cur, _, files in os.walk(args.input_dir):
        ...
        for filename in sorted(files):
            ...
            result = classify_image(image_path, thresholds, args.region_low_percentile)
            result.update(
                {
